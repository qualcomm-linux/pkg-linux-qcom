...
#     SNAPSHOT=20260722.1
#
#   LOCALVERSION always starts with a plus. SNAPSHOT is the dated component of
#   the Debian version; a ref that supplies no date leaves it empty, and the
#   Debian version then carries no +git<date> at all.
#
# Exit codes:
#   0  Success.
